...
function Navbar() {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="/">FindMyEvents</a>
    ...
    <li class="nav-item ">
      ...
      <form className="d-flex">
        <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search"   style={{ marginLeft: "200px", paddingRight: "40rem" }}/>
